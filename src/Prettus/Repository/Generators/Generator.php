    ...
    public function getConfigGeneratorClassPath($class, $directoryPath = false)
    {
        switch ($class) {
            ...
            case ('criteria' === $class):
                ...
                break;
            case ('frontend_api' === $class):
                $path = config('repository.generator.paths.frontend_api', 'Api/Frontend/Controllers');
                break;
            case ('backend_api' === $class):
                $path = config('repository.generator.paths.backend_api', 'Api/Backend/Controllers');
                break;
            default:
                $path = '';
        }
